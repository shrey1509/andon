        ...
        <div id="content">
           ...
           <!--  <div class="row">
            ...
            <div class="row" style="justify-content: center;align-content: center; margin-top: 10px;">
                <h2>Add/Delete/Edit Variant</h2>
            </div>
            <div class="row" style="margin-right: 20px; margin-left: 20px;">
                <div class="col-md-1"></div>
                <div class="col-md-3 formContainerAdmin">
                    <h4 style="text-align: center;">Add Variant</h4>
                    <form action="addVariant.php" method="post" enctype="multipart/form-data">
                    ...
                    <form action="deleteVariant.php" method="post">
                        <div class="form-group">
                           <div class="row" style="margin-top: 5px;">
                               <label for="variantnamedelete" style="font-weight: bold;">Select Variant Name to delete:</label>
                                <select class="form-control" id="variantnamedelete" name="variantnamedelete">
